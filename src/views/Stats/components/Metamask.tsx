  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <TokenImageWrapper>
          <CardImage src="/images/egg/9.png" alt="Farm ZOO logo" width={60} height={60} />
          <hr/>
          <Button onClick={addWatchJaguarToken} size="sm">
            + Add ZOO to <img style={{ marginLeft: 8 }} width={16} src="https://jaguarswap.com/images/tokens/metamask.png" alt="metamask logo" />
          </Button>
        </TokenImageWrapper>
      </CardBody>
    </StyledFarmStakingCard>
